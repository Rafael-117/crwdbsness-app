    ...
    function renderInnerContent$1$1(innerProps) {
        return (y("div", { className: "fc-event-main-frame" },
            ...
            y("div", { className: "fc-event-title-container" },
                y("div", { className: "fc-event-title fc-sticky fas fa-hand-holding-usd" }, '' || y(_, null, "\u00A0")))));
    }
  ...
  const NowIndicatorContainer = (props) => (y(ViewContextType.Consumer, null, (context) => {
    ...
    */
    ...
    function buildDateEnv(settings) {
        let locale = buildLocale(settings.locale || 'es', organizeRawLocales([]).map); // TODO: don't hardcode 'en' everywhere
